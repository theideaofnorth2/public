...
export class MyComponent extends Component {
	shouldComponentUpdate(nextProps) {
		if (
			...
			this.props.background.currentCitieType === nextProps.background.currentCitieType
		) return false;
		return true;
	}
	componentDidUpdate() {
	...
	render() {
		...
		const prevCitie = !this.props.background.prevCitieType
			? {}
			: this.props[this.props.background.prevCitieType].data.find(c =>
				c._id === this.props.background.prevCitieId);
		const currentCitie = this.props[this.props.background.currentCitieType].data.find(c =>
			c._id === this.props.background.currentCitieId);
