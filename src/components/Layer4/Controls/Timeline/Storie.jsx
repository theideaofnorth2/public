  ...
  render() {
    ...
    switch (this.props.storie.view) {
      case "main":
        ...
        break;
      case "origin": {
        const origin = this.props.origins.data.find(
          o => o._id === this.props.storie.originId
        );
        name = origin.name;
        break;
      }
      case "egg": {
        const egg = this.props.eggs.data.find(
          e => e._id === this.props.storie.eggId
        );
        name = egg.name;
        break;
      }
    ...
    return (
      <div onClick={this.onClick} className={thisClass}>
