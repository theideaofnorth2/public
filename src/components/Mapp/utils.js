...
export const getGmContainer = () =>
  document.querySelector(".gm-style > div:nth-child(1)");

export const setLayers = (layer1Class, layer3Class) => {
  const layer1 = document.querySelector(
    ".gm-style > div:nth-child(1) > div:nth-child(1)"
  );
  const layer3 = document.querySelector(
    ".gm-style > div:nth-child(1) > div:nth-child(3) > div:nth-child(2)"
  );
...
export const areCentersEqual = (propsCenter, LatLng) => {
  ...
  return (
    Math.abs(propsCenter.lat - gmapCenter.lat) < 0.0001 &&
