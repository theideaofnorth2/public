    ...
    desktop: {
      en: (
        <div className={css.reason}>
          <i>The Idea Of North 2.0</i>
          {" "}
          isn
          {"'"}
          t supported on your version of
          {" "}
          {browserName}
          .
          <br /><br />
          <a className={css.link} href="http://outdatedbrowser.com/en">
      ...
      fr: (
        <div className={css.reason}>
          ...
          n
          {"'"}
          est pas supporté par votre version de
          {" "}
          {browserName}
          .
          <br /><br />
          <a className={css.link} href="http://outdatedbrowser.com/en">
            Mettez votre navigateur à jour ici
          </a>
          .
        </div>
      )
