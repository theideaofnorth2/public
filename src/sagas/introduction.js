...
function* playIntroduction() {
	try {
		while (true) {
			...
			yield delay(1000);
			yield put({ type: 'INTRODUCTION_TEXT5_SHOW' });
			yield put({ type: 'INTRODUCTION_IMAGE_ROTATE' });
			yield delay(3000);
			yield put({ type: 'INTRODUCTION_TEXT5_HIDE' });
			yield delay(1000);
			yield put({ type: 'INTRODUCTION_TEXT6_SHOW' });
			yield delay(4000);
			yield put({ type: 'INTRODUCTION_TEXT6_HIDE' });
			yield delay(2000);
